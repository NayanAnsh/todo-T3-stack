...
const TaskInput = ({folderName}:{folderName:string}) => {
  ...
  function onSubmit(values: z.infer<typeof TaskFormSchema>) {
    ...
    if(!values.repeat || !values.tags || !values.startDate || !values.endDate  ) return;
         ...
         <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} placeholder={(new Date()).toISOString()} value={startDate} onChange={(e) => setStartDate(e.target?.value)} />
              </FormControl>
              <FormDescription>
                This is your public display name.
              </FormDescription>
        ...
        />
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} placeholder={(new Date()).toISOString()} value={endDate} onChange={(e) => setEndDate(e.target?.value)} />
              </FormControl>
              <FormDescription>
                This is your public display name.
              </FormDescription>
         ...
         <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Input className=""   onChange={(e)=>setTags(e.target?.value.split(","))}  placeholder="tags" />
